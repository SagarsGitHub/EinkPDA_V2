...
Frame programmingScreen(FRAME_LEFT,FRAME_RIGHT + 80,FRAME_TOP_FOR_BOTTOM_TAB + 16,FRAME_BOTTOM,&calcLines,false,true);
Frame numberSizeFrame(FRAME_LEFT + 220,FRAME_RIGHT,FRAME_TOP_FOR_BOTTOM_TAB + 16,FRAME_BOTTOM,&calcLines,false,true);
Frame binaryFrame(FRAME_LEFT_FOR_RIGHT_TAB,FRAME_RIGHT,FRAME_TOP,FRAME_BOTTOM_FOR_TOP_TAB - 16,&calcLines,false,true);
Frame decimalFrame(FRAME_LEFT,FRAME_RIGHT_FOR_LEFT_TAB,FRAME_TOP ,FRAME_BOTTOM_FOR_TOP_TAB + 48,&calcLines,false,true);
Frame octalFrame(FRAME_LEFT,FRAME_RIGHT_FOR_LEFT_TAB,FRAME_TOP + 40,FRAME_BOTTOM_FOR_TOP_TAB + 16,&calcLines,false,true);
Frame hexadecimalFrame(FRAME_LEFT,FRAME_RIGHT_FOR_LEFT_TAB,FRAME_TOP + 72,FRAME_BOTTOM_FOR_TOP_TAB - 16,&calcLines,false,true);
